...
<style>
    ...
    <div class="container">
        ...
        <div class="col-md-12">
            <div class="row">
                <div class="col-md-3">
                    <input type="date" name="date" id="deadline" class="form-control" value="{{ $dateNow->format('Y-m-d') }}">
                </div>
                <div class="col-md-3">
        ...
        $(document).ready(function () {
            $('#chooseFile').on('change', function (event) {
                ...
                for (let i = 0; i < files.length; i++) {
                    ...
                    if (files[i].type != 'image/jpeg' && files[i].type != 'image/png' && files[i].type != 'image/psd' || files[i].size >= 2097152) {
